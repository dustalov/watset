...
eval/pairwise.py --gold=data/ruthes-pairs.txt eval/w2v/*-pairs.txt | tee pairwise-w2v-ruthes.tsv | column -t
eval/pairwise.py --gold=data/yarn-pairs.txt eval/w2v/*-pairs.txt | tee pairwise-w2v-yarn.tsv | column -t
